...
sed -e 's/onnxruntime cmake-3.21.0-linux-x86_64/cmake-3.21.0-linux-x86_64/g' -e 's/--parallel//g' -e 's/4.2/4.3/g' -e 's/xenial/ubuntu/g' -e 's/migraphx_for_ort/develop/g' Dockerfile.migraphx > Dockerfile.migraphx-rocm43
...
docker build ${CACHE} -f Dockerfile.migraphx-rocm43 -t ort:migraphx-rocm43-$DATESTAMP .
