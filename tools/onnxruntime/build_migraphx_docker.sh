...
sed -e 's/onnxruntime cmake-3.14.3-Linux-x86_64/cmake-3.14.3-Linux-x86_64/g' -e 's/--parallel//g' -e 's/debian/3.7/g' -e 's/migraphx_for_ort/upgrade_protobuf_to_3.16/g' Dockerfile.migraphx > Dockerfile.migraphx-rocm37
