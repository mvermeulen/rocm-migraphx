...
echo "\n***** bert-base-cased cpu\n" >> $testdir/dashboard.out
echo "\n***** bert-base-cased cpu\n" >> $testdir/dashboard.err
python benchmark.py -g -m bert-base-cased --sequence_length 16 32 64 128 256 384 512 --batch_sizes 1 --provider=cpu -p int8 --result_csv $testdir/dashboard.csv --detail_csv $testdir/dashboard-detail.csv 1>>$testdir/dashboard.out 2>>$testdir/dashboard.err
python benchmark.py -g -m bert-base-cased --sequence_length 16 32 64 128 256 384 512 --batch_sizes 2 --provider=cpu -p int8 --result_csv $testdir/dashboard.csv --detail_csv $testdir/dashboard-detail.csv 1>>$testdir/dashboard.out 2>>$testdir/dashboard.err
python benchmark.py -g -m bert-base-cased --sequence_length 16 32 64 128 256 384 512 --batch_sizes 4 --provider=cpu -p int8 --result_csv $testdir/dashboard.csv --detail_csv $testdir/dashboard-detail.csv 1>>$testdir/dashboard.out 2>>$testdir/dashboard.err
python benchmark.py -g -m bert-base-cased --sequence_length 16 32 64 128 256 384 512 --batch_sizes 8 --provider=cpu -p int8 --result_csv $testdir/dashboard.csv --detail_csv $testdir/dashboard-detail.csv 1>>$testdir/dashboard.out 2>>$testdir/dashboard.err
python benchmark.py -g -m bert-base-cased --sequence_length 16 32 64 128 256 384 512 --batch_sizes 16 --provider=cpu -p int8 --result_csv $testdir/dashboard.csv --detail_csv $testdir/dashboard-detail.csv 1>>$testdir/dashboard.out 2>>$testdir/dashboard.err
python benchmark.py -g -m bert-base-cased --sequence_length 16 32 64 128 256 384 512 --batch_sizes 32 --provider=cpu -p int8 --result_csv $testdir/dashboard.csv --detail_csv $testdir/dashboard-detail.csv 1>>$testdir/dashboard.out 2>>$testdir/dashboard.err
python benchmark.py -g -m bert-base-cased --sequence_length 16 32 64 128 256 384 512 --batch_sizes 64 --provider=cpu -p int8 --result_csv $testdir/dashboard.csv --detail_csv $testdir/dashboard-detail.csv 1>>$testdir/dashboard.out 2>>$testdir/dashboard.err
python benchmark.py -g -m bert-base-cased --sequence_length 16 32 64 128 256 384 512 --batch_sizes 128 --provider=cpu -p int8 --result_csv $testdir/dashboard.csv --detail_csv $testdir/dashboard-detail.csv 1>>$testdir/dashboard.out 2>>$testdir/dashboard.err
python benchmark.py -g -m bert-base-cased --sequence_length 16 32 64 128 256 384 512 --batch_sizes 256 --provider=cpu -p int8 --result_csv $testdir/dashboard.csv --detail_csv $testdir/dashboard-detail.csv 1>>$testdir/dashboard.out 2>>$testdir/dashboard.err
exit 1
