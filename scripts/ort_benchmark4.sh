...
echo "\n***** bert-large-uncased migraphx engine\n" >> $testdir/dashboard.err
python benchmark.py -g -m bert-large-uncased --sequence_length 32 384 --batch_sizes 1 32 --engine=migraphx -p fp16 --disable_gelu --disable_layer_norm --disable_attention --disable_skip_layer_norm --disable_embed_layer_norm --disable_bias_skip_layer_norm --disable_bias_gelu --result_csv $testdir/dashboard-eng.csv --detail_csv $testdir/dashboard-detail.csv 1>>$testdir/dashboard.out 2>>$testdir/dashboard.err
...
echo "\n***** bert-large-uncased rocm\n" >> $testdir/dashboard.err
python benchmark.py -g -m bert-large-uncased --sequence_length 32 384 --batch_sizes 1 32 --provider=rocm -p fp16 --result_csv $testdir/dashboard-rocm.csv --detail_csv $testdir/dashboard-detail.csv 1>>$testdir/dashboard.out 2>>$testdir/dashboard.err
